...
public sealed record RetroRushPlayerSnapshot(
    ...
    int RoundId,
    long Ability1AvailableAtUnixMs,
    long Ability2AvailableAtUnixMs,
    long Ability3AvailableAtUnixMs);
...
public sealed record RetroRushAbilityApplied(
    int RoundId,
    string AbilityId,
